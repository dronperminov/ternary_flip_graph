...
public:
    ...
    std::string getBudsInvariant() const;
    std::unordered_map<std::string, int> getSerendipitousRanks(std::mt19937 &generator, const std::unordered_map<std::string, int> &dimension2rank, int iterations, int maxN = 16) const;
