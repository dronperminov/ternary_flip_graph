...
ENTITIES_OBJECTS = src/entities/arg_parser.o src/entities/flip_set.o src/entities/ranks.o src/entities/flip_structure_optimizer.o
PARAMETERS_OBJECTS = src/entities/flip_parameters.o src/entities/meta_parameters.o src/entities/pool_parameters.o src/entities/metrics_parameters.o
