...
ENTITIES_OBJECTS = src/entities/arg_parser.o src/entities/flip_set.o src/entities/ranks.o src/entities/flip_structure_optimizer.o src/entities/uint256_t.o src/entities/sha1.o src/entities/ternary_vector.o src/entities/mod3_vector.o src/entities/buffer_writer.o
